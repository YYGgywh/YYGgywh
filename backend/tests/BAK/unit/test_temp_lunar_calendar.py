...
def test_boundary_dates():
    ...
    # 测试1: 闰年2月29日
    print("\n1. 闰年测试 (2024-02-29):")
    test_solar_date_conversion(2024, 2, 29, 12, 0, 0)
    
    # 测试2: 农历闰月
    print("\n2. 农历闰月测试 (2023-07-15):")
    test_solar_date_conversion(2023, 7, 15, 12, 0, 0)
    
    # 测试3: 年末边界
    print("\n3. 年末边界测试 (2024-12-31 23:59:59):")
    test_solar_date_conversion(2024, 12, 31, 23, 59, 59)
    
    # 测试4: 年初边界
    print("\n4. 年初边界测试 (2025-01-01 00:00:00):")
    test_solar_date_conversion(2025, 1, 1, 0, 0, 0)
...
def test_jieqi_precision():
    ...
    # 测试1: 立春时刻前1秒 (2025-02-03 22:10:27)
    print("\n1. 立春前1秒测试:")
    test_solar_date_conversion(2025, 2, 3, 22, 10, 27)
    
    # 测试2: 立春时刻 (2025-02-03 22:10:28)
    print("\n2. 立春时刻测试:")
    test_solar_date_conversion(2025, 2, 3, 22, 10, 28)
    
    # 测试3: 立春后1秒 (2025-02-03 22:10:29)
    print("\n3. 立春后1秒测试:")
    test_solar_date_conversion(2025, 2, 3, 22, 10, 29)
    
    # 测试4: 冬至时刻 (2024-12-21 17:20:35)
    print("\n4. 冬至时刻测试:")
    test_solar_date_conversion(2024, 12, 21, 17, 20, 35)
...
def test_error_handling():
    ...
    # 测试无效日期
    invalid_dates = [
        (2024, 2, 30, 12, 0, 0, "2月30日"),
        (2024, 13, 1, 12, 0, 0, "13月1日"),
        (2024, 1, 32, 12, 0, 0, "1月32日"),
        (2024, 4, 31, 12, 0, 0, "4月31日"),
        (2024, 6, 31, 12, 0, 0, "6月31日")
    ]
    
    for year, month, day, hour, minute, second, desc in invalid_dates:
        print(f"\n测试无效日期: {desc}")
        try:
            test_solar_date_conversion(year, month, day, hour, minute, second)
            print("✅ 意外成功 - 库可能自动修正了日期")
        except Exception as e:
            print(f"❌ 预期错误: {type(e).__name__}: {e}")
    
    # 测试边界值
    extreme_dates = [
        (1900, 1, 1, 0, 0, 0, "1900年"),
        (2100, 12, 31, 23, 59, 59, "2100年"),
        (2024, 1, 1, 24, 0, 0, "24时"),
        (2024, 1, 1, 0, 60, 0, "60分"),
        (2024, 1, 1, 0, 0, 60, "60秒")
    ]
    
    for year, month, day, hour, minute, second, desc in extreme_dates:
        print(f"\n测试边界值: {desc}")
        try:
            test_solar_date_conversion(year, month, day, hour, minute, second)
            print("✅ 处理成功")
