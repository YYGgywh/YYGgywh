...
def test_pillars_conversion():
    ...
    try:
        ...
        try:
            result_1 = calendar_algorithm_core.convert_pillars_to_calendar(**pillars_1)
            print("✅ 四柱转换成功")
        ...
        try:
            result_2 = calendar_algorithm_core.convert_pillars_to_calendar(**pillars_2)
            print("✅ 四柱转换成功")
        ...
        try:
            result_3 = calendar_algorithm_core.convert_pillars_to_calendar(**pillars_3)
            print("❌ 意外成功 - 应该失败")
        ...
        try:
            result_4 = calendar_algorithm_core.convert_pillars_to_calendar(**pillars_4)
            print("✅ 边界情况测试成功")
