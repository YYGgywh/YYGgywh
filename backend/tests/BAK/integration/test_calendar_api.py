...
def test_direct_module():
    ...
    try:
        # 导入正式模块
        from src.core.calendar_algorithm_core import CalendarAlgorithmCore, calendar_algorithm_core
        ...
        pillars_result = calendar_algorithm_core.convert_pillars_to_calendar(**pillars)
        print("✅ calendar_algorithm_core.convert_pillars_to_calendar() - 成功")
