# backend/tests/test_middleware_and_dependencies.py 2026-02-27 10:00:00
# 功能：测试中间件和依赖注入功能
...
def test_sql_injection():
    ...
    response = requests.post(
        ...
        json={
            "pan_type": "liuyao",
            "pan_params": json.dumps({"question": "test' OR '1'='1", "time": "2026-02-27 10:00:00"}),
            "pan_result": json.dumps({"gua": "乾卦", "yao": "初九"}),
            "supplement": "补充说明"
        }
    )
...
def test_xss():
    ...
    response = requests.post(
        ...
        json={
            "pan_type": "liuyao",
            "pan_params": json.dumps({"question": "<script>alert('xss')</script>", "time": "2026-02-27 10:00:00"}),
            "pan_result": json.dumps({"gua": "乾卦", "yao": "初九"}),
            "supplement": "补充说明"
        }
    )
