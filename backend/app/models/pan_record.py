...
class PanRecord(Base):
    ...
    supplement_create_time = Column(Integer, nullable=True)
    supplement_update_time = Column(Integer, nullable=True)
    supplement_modify_count = Column(Integer, default=0)
