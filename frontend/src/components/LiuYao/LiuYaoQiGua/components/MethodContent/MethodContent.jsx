/*
 * @file            frontend/src/components/LiuYao/LiuYaoQiGua/components/MethodContent/MethodContent.jsx
...
import SpecifiedMethod from '../methods/SpecifiedMethod/SpecifiedMethod'; // 导入指定起卦组件
