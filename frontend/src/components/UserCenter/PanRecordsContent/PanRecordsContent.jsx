        ...
        {records.map((record) => (
          <div key={record.id} className={styles.recordCard}>
            ...
            <div className={styles.recordCardBody}>
              ...
              {record.supplement && (
                <div className={styles.recordSupplement}>
                  <span className={styles.supplementLabel}>补充说明：</span>
                  <span className={styles.supplementValue}>{record.supplement}</span>
                </div>
              )}
            </div>
            <div className={styles.recordCardFooter}>
              <button
                className={`${styles.recordActionBtn} ${styles.recordActionBtnPrimary}`}
                onClick={() => onViewDetail(record)}
              >
                查看详情
              </button>
              <button className={styles.recordActionBtn}>
