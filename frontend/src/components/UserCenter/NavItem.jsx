/*
 * @file            frontend/src/components/UserCenter/NavItem.jsx
 * @description     导航项组件，支持图标和文字，带激活状态样式
 * @author          Gordon <gordon_cao@qq.com>
 * @createTime      2026-03-03 20:42:00
 * @lastModified    2026-03-03 20:42:00
...
export const UserIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="nav-item-icon">
