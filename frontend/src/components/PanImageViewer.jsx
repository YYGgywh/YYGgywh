/*
 * @file            frontend/src/components/PanImageViewer.jsx
 * @description     图片查看器组件，支持多张图片浏览、切换和关闭功能
 * @author          圆运阁古易文化 <gordon_cao@qq.com>
 * @createTime      2026-03-11 10:00:00
 * @lastModified    2026-03-11 14:17:10
        ...
        {images.length > 1 && (
          <div className="viewer-indicator">
            ...
            {images.map((_, index) => (
              <span
                key={index} // 唯一键
                className={`indicator-dot ${index === currentIndex ? 'active' : ''}`} // 激活状态
                onClick={(e) => {
                  // 阻止事件冒泡，避免触发遮罩层的点击事件
                  e.stopPropagation();
                  // 直接跳转到点击的图片索引
